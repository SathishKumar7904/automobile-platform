...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public Map<String, Object> handleLeadNotFound(
    ...
    public Map<String, Object> handleInvalidDealer(
            InvalidDealerAssignmentException ex) {
    ...
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    public Map<String, Object> handleInvalidLeadStatusTransition(
    ...
    public Map<String, Object> handleDependency(
            DependencyServiceUnavailableException ex) {
