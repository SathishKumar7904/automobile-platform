...
import { Brand, VehicleModel, VehicleVariant, Dealer, CustomerEnquiry, EnquiryCreatedResponse, Lead, StatusHistory, LeadNote, CreateEnquiryRequest, UpdateLeadStatusRequest, CreateLeadNoteRequest } from './models';
...
export class ApiService {
  ...
  createEnquiry(request: CreateEnquiryRequest): Observable<EnquiryCreatedResponse> { return this.http.post<EnquiryCreatedResponse>('/api/enquiries', request); }
